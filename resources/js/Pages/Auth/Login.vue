...
function loginDemoInfoprodutor() {
    router.post('/demo/login/infoprodutor');
}
</script>
...
<template>
    ...
    >
        <div class="w-full max-w-md rounded-2xl border border-zinc-200/80 bg-white p-8 shadow-sm dark:border-white/10 dark:bg-[#1A1A24]">
            ...
            <div
                v-if="demoMode"
                class="mt-6 space-y-3 rounded-xl border border-zinc-200 bg-zinc-50 p-4 dark:border-white/10 dark:bg-zinc-900/50"
            >
                <p class="text-center text-sm font-semibold text-zinc-800 dark:text-zinc-200">Modo demo</p>
                <Button
                    type="button"
                ...
                <Button type="button" variant="outline" class="w-full" @click="loginDemoInfoprodutor">
                    Logar como infoprodutor
                </Button>
            </div>
